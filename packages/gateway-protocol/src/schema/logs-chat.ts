...
export const ChatSendParamsSchema = closedObject({
  ...
  /** Bench fork #82: cloud auth for remote-brain dispatch through the Bench cloud bridge. */
  cloudAuth: Type.Optional(closedObject({ firebaseIdToken: Type.Optional(Type.String()) })),
