...
export const en: TranslationMap & {
  ...
  approvalPage: {
    brandName: "BenchAGI Aurelius Vault",
  ...
  custodian: {
    ...
    sessionRestarted:
      "{error} Aurelius started a fresh session; earlier messages remain for context.",
    unsupportedGateway: "Update the Gateway to continue setup with Aurelius.",
    panel: {
      title: "Aurelius",
  ...
  aboutPage: {
    ...
    tagline: "Your AI employees, running on your own cell. Aurelius runs the room.",
    waveHello: "Say hi to Aurelius",
    linksLabel: "Bench resources",
    linkWebsite: "Website",
    linkDocs: "Docs",
    linkHelp: "Get help",
    linkWhatsNew: "What's new",
    linkAgents: "Your agents",
    linkGitHub: "GitHub",
    linkDiscord: "Discord",
    linkX: "X (Twitter)",
    linkChangelog: "Changelog",
    license:
      "Built on OpenClaw, MIT licensed. Bench, Aurelius, and the agent names are trademarks of BenchAGI.",
