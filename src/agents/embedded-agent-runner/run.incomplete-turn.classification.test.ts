...
describe("incomplete-turn classification", () => {
  it("surfaces a blocked tool when the completed turn has no final assistant reply", () => {
    // Bench fork #107: tool-warning policy can suppress ordinary exec errors and
    // leave payloadCount at zero; without a final reply that is still an incomplete turn.
