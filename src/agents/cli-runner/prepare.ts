...
export async function prepareCliRunContext(
  ...
  // F1 — Tier-1 retrieval-at-start for the CLI backend (Bench fork #63) — the path
  // claude-cli-backed agents actually run. A populated contextFiles means a cold-start
  // bootstrap (MEMORY.md injected), exactly when we want to prepend a small retrieved
  // prior-context slice ahead of MEMORY.md. Flag-gated, fail-open, bounded; on any
  // miss tier1ContextFiles == contextFiles unchanged.
