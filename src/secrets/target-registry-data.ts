...
const CORE_SECRET_TARGET_REGISTRY: SecretTargetRegistryEntry[] = [
  ...
  {
    id: "memory.search.query.reranker.apiKey",
    targetType: "memory.search.query.reranker.apiKey",
    configFile: "openclaw.json",
    pathPattern: "memory.search.query.reranker.apiKey",
    secretShape: SECRET_INPUT_SHAPE,
    expectedResolvedValue: "string",
    includeInPlan: true,
    includeInConfigure: true,
  ...
  {
    id: "agents.entries.*.memory.search.query.reranker.apiKey",
    targetType: "agents.entries.*.memory.search.query.reranker.apiKey",
    configFile: "openclaw.json",
    pathPattern: "agents.entries.*.memory.search.query.reranker.apiKey",
    secretShape: SECRET_INPUT_SHAPE,
    expectedResolvedValue: "string",
    includeInPlan: true,
    includeInConfigure: true,
