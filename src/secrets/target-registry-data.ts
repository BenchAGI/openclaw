...
const CORE_SECRET_TARGET_REGISTRY: SecretTargetRegistryEntry[] = [
  ...
  {
    id: "agents.defaults.memorySearch.query.reranker.apiKey",
    targetType: "agents.defaults.memorySearch.query.reranker.apiKey",
    configFile: "openclaw.json",
    pathPattern: "agents.defaults.memorySearch.query.reranker.apiKey",
    secretShape: SECRET_INPUT_SHAPE,
    expectedResolvedValue: "string",
    includeInPlan: true,
    includeInConfigure: true,
  ...
  {
    id: "agents.list[].memorySearch.query.reranker.apiKey",
    targetType: "agents.list[].memorySearch.query.reranker.apiKey",
    configFile: "openclaw.json",
    pathPattern: "agents.list[].memorySearch.query.reranker.apiKey",
    secretShape: SECRET_INPUT_SHAPE,
    expectedResolvedValue: "string",
    includeInPlan: true,
    includeInConfigure: true,
