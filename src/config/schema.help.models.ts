...
export const MODEL_FIELD_HELP: Record<string, string> = {
  ...
  "memory.search.query.tier1.enabled":
  ...
  "memory.search.query.tier1.maxResults":
  ...
  "memory.search.query.tier1.timeoutMs":
  ...
  "memory.search.query.reranker.enabled":
  ...
  "memory.search.query.reranker.baseUrl":
  ...
  "memory.search.query.reranker.minScore":
  ...
  "memory.search.query.reranker.topK":
