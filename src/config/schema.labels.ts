...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "memory.search.query.tier1": "Tier-1 Retrieval at Start",
  "memory.search.query.tier1.enabled": "Enable Tier-1 Retrieval at Start",
  "memory.search.query.tier1.maxResults": "Tier-1 Max Results",
  "memory.search.query.tier1.minScore": "Tier-1 Min Score",
  "memory.search.query.tier1.maxBytes": "Tier-1 Max Bytes",
  "memory.search.query.tier1.timeoutMs": "Tier-1 Timeout (ms)",
  "memory.search.query.reranker": "Tier-1 Reranker",
  "memory.search.query.reranker.enabled": "Enable Tier-1 Reranker",
  "memory.search.query.reranker.baseUrl": "Tier-1 Reranker Base URL",
  "memory.search.query.reranker.apiKey": "Tier-1 Reranker API Key", // pragma: allowlist secret
  "memory.search.query.reranker.model": "Tier-1 Reranker Model",
  "memory.search.query.reranker.timeoutMs": "Tier-1 Reranker Timeout (ms)",
  "memory.search.query.reranker.minScore": "Tier-1 Reranker Min Score",
  "memory.search.query.reranker.topK": "Tier-1 Reranker Top K",
