...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "gateway.benchCloud.apiKeyRef": "Bench Cloud API Key Ref",
  "gateway.benchCloud.workboardSync": "Bench Cloud Workboard Sync",
  "gateway.benchCloud.workboardSync.enabled": "Bench Cloud Workboard Sync Enabled",
  "gateway.benchCloud.workboardSync.pollIntervalMs":
    "Bench Cloud Workboard Sync Poll Interval (ms)",
  "gateway.benchCloud.skillSync": "Bench Cloud Skill Sync",
  "gateway.benchCloud.skillSync.enabled": "Bench Cloud Skill Sync Enabled",
  "gateway.benchCloud.skillSync.mirrorPendingUp": "Bench Cloud Skill Sync Mirror Pending Up",
  ...
  "agents.defaults.memorySearch.query.tier1": "Tier-1 Retrieval at Start",
  "agents.defaults.memorySearch.query.tier1.enabled": "Enable Tier-1 Retrieval at Start",
  "agents.defaults.memorySearch.query.tier1.maxResults": "Tier-1 Max Results",
  "agents.defaults.memorySearch.query.tier1.minScore": "Tier-1 Min Score",
  "agents.defaults.memorySearch.query.tier1.maxBytes": "Tier-1 Max Bytes",
  "agents.defaults.memorySearch.query.tier1.timeoutMs": "Tier-1 Timeout (ms)",
  "agents.defaults.memorySearch.query.reranker": "Tier-1 Reranker",
  "agents.defaults.memorySearch.query.reranker.enabled": "Enable Tier-1 Reranker",
  "agents.defaults.memorySearch.query.reranker.baseUrl": "Tier-1 Reranker Base URL",
  "agents.defaults.memorySearch.query.reranker.apiKey": "Tier-1 Reranker API Key", // pragma: allowlist secret
  "agents.defaults.memorySearch.query.reranker.model": "Tier-1 Reranker Model",
  "agents.defaults.memorySearch.query.reranker.timeoutMs": "Tier-1 Reranker Timeout (ms)",
  "agents.defaults.memorySearch.query.reranker.minScore": "Tier-1 Reranker Min Score",
  "agents.defaults.memorySearch.query.reranker.topK": "Tier-1 Reranker Top K",
