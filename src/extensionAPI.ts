// Legacy compat surface for plugins that still import @benchagi/openclaw/extension-api.
...
if (shouldWarnExtensionApiImport) {
  process.emitWarning(
    "@benchagi/openclaw/extension-api is deprecated. Migrate to api.runtime.agent.* or focused @benchagi/openclaw/plugin-sdk/<subpath> imports. See https://docs.openclaw.ai/plugins/sdk-migration",
    {
