...
type LoginOpenAICodexOAuth =
  (typeof import("@benchagi/openclaw/plugin-sdk/provider-auth-login"))["loginOpenAICodexOAuth"];
type GithubCopilotLoginCommand =
  (typeof import("@benchagi/openclaw/plugin-sdk/provider-auth-login"))["githubCopilotLoginCommand"];
...
type EnsureAuthProfileStore =
  typeof import("@benchagi/openclaw/plugin-sdk/provider-auth").ensureAuthProfileStore;
type ListProfilesForProvider =
  typeof import("@benchagi/openclaw/plugin-sdk/provider-auth").listProfilesForProvider;
...
vi.mock("@benchagi/openclaw/plugin-sdk/provider-auth-login", async () => {
  const actual = await vi.importActual<typeof import("@benchagi/openclaw/plugin-sdk/provider-auth-login")>(
    "@benchagi/openclaw/plugin-sdk/provider-auth-login",
  );
  return {
    ...actual,
...
vi.mock("@benchagi/openclaw/plugin-sdk/provider-auth", async () => {
  const actual = await vi.importActual<typeof import("@benchagi/openclaw/plugin-sdk/provider-auth")>(
    "@benchagi/openclaw/plugin-sdk/provider-auth",
  );
  return {
    ...actual,
