...
function removeStaleOpenClawSelfReference(sourcePluginNodeModulesDir, repoRoot) {
  ...
  const selfReferencePath = path.join(sourcePluginNodeModulesDir, "@benchagi", "openclaw");
  try {
