...
import { formatAllowlistMatchMeta } from "@benchagi/openclaw/plugin-sdk/allow-from";
import {
  buildMentionRegexes,
...
import { resolveControlCommandGate } from "@benchagi/openclaw/plugin-sdk/command-auth-native";
import { hasControlCommand } from "@benchagi/openclaw/plugin-sdk/command-detection";
import { shouldHandleTextCommands } from "@benchagi/openclaw/plugin-sdk/command-surface";
import { isDangerousNameMatchingEnabled, loadConfig } from "@benchagi/openclaw/plugin-sdk/config-runtime";
import type { SessionBindingRecord } from "@benchagi/openclaw/plugin-sdk/conversation-binding-runtime";
import { enqueueSystemEvent, recordChannelActivity } from "@benchagi/openclaw/plugin-sdk/infra-runtime";
import {
  recordPendingHistoryEntryIfEnabled,
  type HistoryEntry,
} from "@benchagi/openclaw/plugin-sdk/reply-history";
import { getChildLogger, logVerbose, shouldLogVerbose } from "@benchagi/openclaw/plugin-sdk/runtime-env";
import { logDebug, normalizeOptionalString } from "@benchagi/openclaw/plugin-sdk/text-runtime";
...
let conversationRuntimePromise:
  | Promise<typeof import("@benchagi/openclaw/plugin-sdk/conversation-binding-runtime")>
  | undefined;
...
async function loadConversationRuntime() {
  conversationRuntimePromise ??= import("@benchagi/openclaw/plugin-sdk/conversation-binding-runtime");
