...
vi.mock("@benchagi/openclaw/plugin-sdk/approval-gateway-runtime", async (importOriginal) => {
  const actual =
    await importOriginal<typeof import("@benchagi/openclaw/plugin-sdk/approval-gateway-runtime")>();
  return {
    ...actual,
