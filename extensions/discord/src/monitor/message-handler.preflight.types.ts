...
import type { SessionBindingRecord } from "@benchagi/openclaw/plugin-sdk/conversation-runtime";
import type { HistoryEntry } from "@benchagi/openclaw/plugin-sdk/reply-history";
import type { resolveAgentRoute } from "@benchagi/openclaw/plugin-sdk/routing";
...
export type LoadedConfig = ReturnType<
  typeof import("@benchagi/openclaw/plugin-sdk/config-runtime").loadConfig
>;
export type RuntimeEnv = import("@benchagi/openclaw/plugin-sdk/runtime-env").RuntimeEnv;
...
type DiscordMessagePreflightSharedFields = {
  ...
  discordConfig: NonNullable<
    import("@benchagi/openclaw/plugin-sdk/config-runtime").OpenClawConfig["channels"]
  >["discord"];
  accountId: string;
  token: string;
  runtime: RuntimeEnv;
