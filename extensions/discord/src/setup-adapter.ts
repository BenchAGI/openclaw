import { createEnvPatchedAccountSetupAdapter } from "@benchagi/openclaw/plugin-sdk/setup-adapter-runtime";
import type { ChannelSetupAdapter } from "@benchagi/openclaw/plugin-sdk/setup-runtime";
