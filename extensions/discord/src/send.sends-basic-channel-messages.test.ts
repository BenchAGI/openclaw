...
vi.mock("@benchagi/openclaw/plugin-sdk/web-media", () => discordWebMediaMockFactory());
...
let loadWebMedia: typeof import("@benchagi/openclaw/plugin-sdk/web-media").loadWebMedia;
...
beforeAll(async () => {
  ...
  ({ loadWebMedia } = await import("@benchagi/openclaw/plugin-sdk/web-media"));
