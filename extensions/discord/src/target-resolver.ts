import type { DirectoryConfigParams } from "@benchagi/openclaw/plugin-sdk/directory-runtime";
import { buildMessagingTarget, type MessagingTarget } from "@benchagi/openclaw/plugin-sdk/messaging-targets";
