...
import { waitUntilAbort } from "@benchagi/openclaw/plugin-sdk/channel-lifecycle";
...
export type MonitorMatrixOpts = {
  ...
  setStatus?: (next: import("@benchagi/openclaw/plugin-sdk/channel-contract").ChannelAccountSnapshot) => void;
};
