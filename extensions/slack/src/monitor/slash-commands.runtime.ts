...
type BuildCommandTextFromArgs =
  typeof import("@benchagi/openclaw/plugin-sdk/command-auth").buildCommandTextFromArgs;
type FindCommandByNativeName =
  typeof import("@benchagi/openclaw/plugin-sdk/command-auth").findCommandByNativeName;
type ListNativeCommandSpecsForConfig =
  typeof import("@benchagi/openclaw/plugin-sdk/command-auth").listNativeCommandSpecsForConfig;
type ParseCommandArgs = typeof import("@benchagi/openclaw/plugin-sdk/command-auth").parseCommandArgs;
type ResolveCommandArgMenu =
  typeof import("@benchagi/openclaw/plugin-sdk/command-auth").resolveCommandArgMenu;
