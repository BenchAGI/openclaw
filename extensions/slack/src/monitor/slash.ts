...
import { type ChatCommandDefinition, type CommandArgs } from "@benchagi/openclaw/plugin-sdk/command-auth";
import {
...
import { chunkItems, normalizeLowercaseStringOrEmpty } from "@benchagi/openclaw/plugin-sdk/text-runtime";
