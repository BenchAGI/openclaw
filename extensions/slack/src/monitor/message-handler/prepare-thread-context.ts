import { formatInboundEnvelope } from "@benchagi/openclaw/plugin-sdk/channel-inbound";
import type { ContextVisibilityMode } from "@benchagi/openclaw/plugin-sdk/config-runtime";
...
export async function resolveSlackThreadContextData(params: {
  ...
  envelopeOptions: ReturnType<
    typeof import("@benchagi/openclaw/plugin-sdk/channel-inbound").resolveEnvelopeFormatOptions
  >;
