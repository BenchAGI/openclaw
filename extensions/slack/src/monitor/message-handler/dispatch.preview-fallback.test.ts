...
vi.mock("@benchagi/openclaw/plugin-sdk/channel-feedback", () => ({
  DEFAULT_TIMING: {
    doneHoldMs: 0,
    errorHoldMs: 0,
  },
...
vi.mock("@benchagi/openclaw/plugin-sdk/channel-streaming", () => ({
  resolveChannelStreamingBlockEnabled: () => false,
  resolveChannelStreamingNativeTransport: () => false,
}));

vi.mock("@benchagi/openclaw/plugin-sdk/outbound-runtime", () => ({
...
vi.mock("@benchagi/openclaw/plugin-sdk/reply-payload", () => ({
...
vi.mock("@benchagi/openclaw/plugin-sdk/security-runtime", () => ({
  resolvePinnedMainDmOwnerFromAllowlist: () => undefined,
}));

vi.mock("@benchagi/openclaw/plugin-sdk/text-runtime", () => ({
