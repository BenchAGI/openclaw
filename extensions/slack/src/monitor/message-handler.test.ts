...
vi.mock("@benchagi/openclaw/plugin-sdk/channel-inbound", async () => {
  const actual = await vi.importActual<typeof import("@benchagi/openclaw/plugin-sdk/channel-inbound")>(
    "@benchagi/openclaw/plugin-sdk/channel-inbound",
  );
  return {
    ...actual,
