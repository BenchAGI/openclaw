...
vi.mock("@benchagi/openclaw/plugin-sdk/infra-runtime", createChannelRuntimeMock);
vi.mock("@benchagi/openclaw/plugin-sdk/infra-runtime.js", createChannelRuntimeMock);
