...
import { createDedupeCache } from "@benchagi/openclaw/plugin-sdk/infra-runtime";
...
export type SlackMonitorContext = {
  ...
  slashCommand: Required<import("@benchagi/openclaw/plugin-sdk/config-runtime").SlackSlashCommandConfig>;
  textLimit: number;
