export { HEARTBEAT_PROMPT, stripHeartbeatToken } from "@benchagi/openclaw/plugin-sdk/reply-runtime";
export { HEARTBEAT_TOKEN, SILENT_REPLY_TOKEN } from "@benchagi/openclaw/plugin-sdk/reply-runtime";
