...
import type { checkQmdBinaryAvailability as checkQmdBinaryAvailabilityFn } from "@benchagi/openclaw/plugin-sdk/memory-core-host-engine-qmd";
...
vi.mock("@benchagi/openclaw/plugin-sdk/memory-core-host-engine-qmd", () => ({
