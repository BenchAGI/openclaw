...
vi.mock("./cli.host.runtime.js", async () => {
  const [runtimeCli, runtimeCore, runtimeFiles] = await Promise.all([
    import("@benchagi/openclaw/plugin-sdk/memory-core-host-runtime-cli"),
    import("@benchagi/openclaw/plugin-sdk/memory-core-host-runtime-core"),
    import("@benchagi/openclaw/plugin-sdk/memory-core-host-runtime-files"),
  ]);
  return {
...
let defaultRuntime: typeof import("@benchagi/openclaw/plugin-sdk/memory-core-host-runtime-cli").defaultRuntime;
let isVerbose: typeof import("@benchagi/openclaw/plugin-sdk/memory-core-host-runtime-cli").isVerbose;
let setVerbose: typeof import("@benchagi/openclaw/plugin-sdk/memory-core-host-runtime-cli").setVerbose;
let fixtureRoot = "";
...
beforeAll(async () => {
  ...
  ({ defaultRuntime, isVerbose, setVerbose } =
    await import("@benchagi/openclaw/plugin-sdk/memory-core-host-runtime-cli"));
