...
vi.mock("./nostr-profile-http-runtime.js", async () => {
  const webhookIngress = await import("@benchagi/openclaw/plugin-sdk/webhook-ingress");
  const requestGuards = await import("@benchagi/openclaw/plugin-sdk/webhook-request-guards");
  return {
