...
vi.mock("@benchagi/openclaw/plugin-sdk/setup", async () => {
  const actual = await vi.importActual<object>("@benchagi/openclaw/plugin-sdk/setup");
  return {
    ...actual,
...
vi.mock("@benchagi/openclaw/plugin-sdk/channel-config-schema", async () => {
  const actual = await vi.importActual<object>("@benchagi/openclaw/plugin-sdk/channel-config-schema");
  return {
    ...actual,
...
vi.mock("@benchagi/openclaw/plugin-sdk/webhook-ingress", async () => {
  const actual = await vi.importActual<object>("@benchagi/openclaw/plugin-sdk/webhook-ingress");
  return {
    ...actual,
