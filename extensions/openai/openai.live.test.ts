...
import type { ResolvedTtsConfig } from "@benchagi/openclaw/plugin-sdk/agent-runtime";
...
import { encodePngRgba, fillPixel } from "@benchagi/openclaw/plugin-sdk/media-runtime";
