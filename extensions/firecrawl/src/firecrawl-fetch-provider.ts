import type { WebFetchProviderPlugin } from "@benchagi/openclaw/plugin-sdk/provider-web-fetch";
import { enablePluginInConfig } from "@benchagi/openclaw/plugin-sdk/provider-web-fetch";
