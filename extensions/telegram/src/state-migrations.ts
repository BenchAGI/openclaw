...
import type { ChannelLegacyStateMigrationPlan } from "@benchagi/openclaw/plugin-sdk/channel-contract";
import { resolveChannelAllowFromPath } from "@benchagi/openclaw/plugin-sdk/channel-pairing-paths";
