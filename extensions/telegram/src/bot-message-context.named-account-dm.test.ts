...
let clearRuntimeConfigSnapshot: typeof import("@benchagi/openclaw/plugin-sdk/config-runtime").clearRuntimeConfigSnapshot;
let setRuntimeConfigSnapshot: typeof import("@benchagi/openclaw/plugin-sdk/config-runtime").setRuntimeConfigSnapshot;
