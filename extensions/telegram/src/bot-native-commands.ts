...
import type { ChannelGroupPolicy } from "@benchagi/openclaw/plugin-sdk/config-runtime";
import type {
  ReplyToMode,
...
import { getRuntimeConfigSnapshot } from "@benchagi/openclaw/plugin-sdk/runtime-config-snapshot";
...
type TelegramChunkMode = ReturnType<
  typeof import("@benchagi/openclaw/plugin-sdk/reply-dispatch-runtime").resolveChunkMode
>;
type TelegramNativeReplyPayload = import("@benchagi/openclaw/plugin-sdk/reply-dispatch-runtime").ReplyPayload;
