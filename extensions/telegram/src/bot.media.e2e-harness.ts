...
import type { GetReplyOptions, MsgContext } from "@benchagi/openclaw/plugin-sdk/reply-runtime";
...
type DispatchReplyWithBufferedBlockDispatcherFn =
  typeof import("@benchagi/openclaw/plugin-sdk/reply-runtime").dispatchReplyWithBufferedBlockDispatcher;
type DispatchReplyHarnessParams = Parameters<DispatchReplyWithBufferedBlockDispatcherFn>[0];
type FetchRemoteMediaFn = typeof import("@benchagi/openclaw/plugin-sdk/media-runtime").fetchRemoteMedia;
