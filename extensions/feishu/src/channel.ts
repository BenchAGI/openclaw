...
import { createMessageToolCardSchema } from "@benchagi/openclaw/plugin-sdk/channel-actions";
import {
...
export const feishuPlugin: ChannelPlugin<ResolvedFeishuAccount, FeishuProbeResult> =
  createChatChannelPlugin({
    base: {
      ...
      auth: {
        login: async ({ cfg }) => {
          const { createClackPrompter } = await import("@benchagi/openclaw/plugin-sdk/setup-runtime");
          const { writeConfigFile } = await import("@benchagi/openclaw/plugin-sdk/config-runtime");
