...
import { resolveDualTextControlCommandGate } from "@benchagi/openclaw/plugin-sdk/command-auth";
...
import { sanitizeTerminalText } from "@benchagi/openclaw/plugin-sdk/text-runtime";
