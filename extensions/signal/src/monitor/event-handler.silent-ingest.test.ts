...
vi.mock("@benchagi/openclaw/plugin-sdk/hook-runtime", async () => {
  const actual = await vi.importActual<typeof import("@benchagi/openclaw/plugin-sdk/hook-runtime")>(
    "@benchagi/openclaw/plugin-sdk/hook-runtime",
  );
  return {
    ...actual,
