import { definePluginEntry, type ProviderAuthContext } from "@benchagi/openclaw/plugin-sdk/plugin-entry";
import { ensureAuthProfileStore } from "@benchagi/openclaw/plugin-sdk/provider-auth";
