import type { ChannelSetupAdapter, OpenClawConfig } from "@benchagi/openclaw/plugin-sdk/setup";
import { createSetupInputPresenceValidator } from "@benchagi/openclaw/plugin-sdk/setup";
