...
vi.mock("@benchagi/openclaw/plugin-sdk/channel-inbound", () => ({
  buildMentionRegexes: () => [],
...
vi.mock("@benchagi/openclaw/plugin-sdk/channel-pairing", () => ({
...
vi.mock("@benchagi/openclaw/plugin-sdk/command-auth", () => ({
...
vi.mock("@benchagi/openclaw/plugin-sdk/config-runtime", () => ({
...
vi.mock("@benchagi/openclaw/plugin-sdk/group-access", () => ({
...
vi.mock("@benchagi/openclaw/plugin-sdk/reply-history", () => ({
...
vi.mock("@benchagi/openclaw/plugin-sdk/routing", () => ({
