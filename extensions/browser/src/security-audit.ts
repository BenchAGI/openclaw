import type { OpenClawPluginSecurityAuditContext } from "@benchagi/openclaw/plugin-sdk/plugin-entry";
import { hasConfiguredSecretInput } from "@benchagi/openclaw/plugin-sdk/secret-input";
import { formatCliCommand } from "@benchagi/openclaw/plugin-sdk/setup-tools";
import { isPrivateNetworkOptInEnabled, isPrivateIpAddress } from "@benchagi/openclaw/plugin-sdk/ssrf-policy";
