...
vi.mock("@benchagi/openclaw/plugin-sdk/browser-config-runtime", () => ({
  loadConfig: configMocks.loadConfig,
}));

vi.mock("@benchagi/openclaw/plugin-sdk/browser-node-runtime", () => ({
  withTimeout: vi.fn(
    async (
...
vi.mock("@benchagi/openclaw/plugin-sdk/browser-setup-tools", () => ({
